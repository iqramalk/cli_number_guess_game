...
const message1 = chalk.blue.bold.underline.dim(
  "!!!!!WELCOME TO NUMBER GUESSING GAME!!!!!"
);
const message2 = chalk.yellowBright.bold.italic(
  "      TRY TO GUESS THE CORRECT NUMBER          "
);
const message3 = chalk.green.bold(" !!!!LETS START NOW!!!!");
const message4 = chalk.red.bold(
  "OMG ! You nailed it U are a winner of this game "
);
...
const message7 = chalk.redBright.bold.underline(
  "<~> You Missed your Three chances<..>"
);
const message8 = chalk.greenBright.bold(
  "~~IN THIS GAME YOU HAVE THREE CHANCES TO WIN SO, TRY YOUR LUCK~~"
);
